...
import pytest
from pageObjects.CDPostpaidExistingNewRegistration import PostPaidExistingNewRegistration
...
class Test_NewRegistration:
    ...
    def test_PostPaidExistingNewRegistration(self, setup):
        self.driver = setup
        self.driver.get(self.appURL)
        self.pPNR = PostPaidNewRegistration(self.driver)
        # time.sleep(10)
        self.pPNR.clickBuyNow160Button()
        self.pPENR = PostPaidExistingNewRegistration(self.driver)
        self.pPENR.clickToggleButton()
